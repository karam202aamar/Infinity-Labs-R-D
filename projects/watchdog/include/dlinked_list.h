...
** Return value: The inserted iterator or DListEnd dummy on failure
** Complexity: O(1), WC O(n) (on failure)
** Undefined behavior: If iter is NULL
*******************************************************************************/
...
/*******************************************************************************
** Appends the list of nodes that are in the range of (from, to) and attaches
** the appended list to the location of the dest iterator (after dest iterator)
** Return value: Iterator of the first element added to the dest iterator
** Coplexity: O(1)
