...
typedef enum {SUCCESS, FAIL} Status_ty;
...
char *input_cmd = (char *)malloc(sizeof(int)*80);
	...
	{	
		...
		if(SUCCESS == structs_array[i].compare(structs_array[i].cmd,input_cmd))
		{
			flag = SUCCESS;
